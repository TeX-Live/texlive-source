...
#line 118 "runstring.in"
  addFunc(ve, run::gen_runstring1, primInt(), "length", formal(primString(), "s", false, false));
#line 123 "runstring.in"
  addFunc(ve, run::gen_runstring2, primInt(), "find", formal(primString(), "s", false, false), formal(primString() , "t", false, false), formal(primInt(), "pos", true, false));
#line 129 "runstring.in"
  addFunc(ve, run::gen_runstring3, primInt(), "rfind", formal(primString(), "s", false, false), formal(primString() , "t", false, false), formal(primInt(), "pos", true, false));
#line 135 "runstring.in"
  addFunc(ve, run::gen_runstring4, primString() , "reverse", formal(primString() , "s", false, false));
#line 141 "runstring.in"
  addFunc(ve, run::gen_runstring5, primString() , "insert", formal(primString() , "s", false, false), formal(primInt(), "pos", false, false), formal(primString() , "t", false, false));
#line 148 "runstring.in"
  addFunc(ve, run::gen_runstring6, primString() , "substr", formal(primString(), "s", false, false), formal(primInt(), "pos", false, false), formal(primInt(), "n", true, false));
#line 155 "runstring.in"
  addFunc(ve, run::gen_runstring7, primString() , "erase", formal(primString() , "s", false, false), formal(primInt(), "pos", false, false), formal(primInt(), "n", false, false));
#line 162 "runstring.in"
  addFunc(ve, run::gen_runstring8, primString() , "downcase", formal(primString() , "s", false, false));
#line 168 "runstring.in"
  addFunc(ve, run::gen_runstring9, primString() , "upcase", formal(primString() , "s", false, false));
#line 174 "runstring.in"
  addFunc(ve, run::gen_runstring10, primString() , "replace", formal(primString(), "s", false, false), formal(stringArray2(), "translate", false, false));
#line 201 "runstring.in"
  addFunc(ve, run::gen_runstring11, primString() , "format", formal(primString(), "format", false, false), formal(primInt(), "x", false, false));
#line 216 "runstring.in"
  addFunc(ve, run::gen_runstring12, primString() , "format", formal(primString(), "format", false, false), formal(primReal(), "x", false, false), formal(primString() , "locale", true, false));
#line 341 "runstring.in"
  addFunc(ve, run::gen_runstring13, primInt(), "hex", formal(primString() , "s", false, false));
#line 352 "runstring.in"
  addFunc(ve, run::gen_runstring14, primString() , "string", formal(primInt(), "x", false, false));
#line 359 "runstring.in"
  addFunc(ve, run::gen_runstring15, primString() , "string", formal(primReal(), "x", false, false), formal(primInt(), "digits", true, false));
#line 367 "runstring.in"
  addFunc(ve, run::gen_runstring16, primString() , "time", formal(primString() , "format", true, false));
#line 378 "runstring.in"
  addFunc(ve, run::gen_runstring17, primString() , "time", formal(primInt(), "seconds", false, false), formal(primString() , "format", true, false));
#line 391 "runstring.in"
  addFunc(ve, run::gen_runstring18, primInt(), "seconds", formal(primString() , "t", true, false), formal(primString() , "format", true, false));
}
