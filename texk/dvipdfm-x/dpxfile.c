 ...
 * injection.  exec_spawn() splits on spaces and handles '...' and (at
 * the beginning of words) "..." but has no escape mechanism for
 * embedded quotes.  No shell is involved, we ultimately call execvp.
 */
static int
